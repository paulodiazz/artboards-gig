...
import { BrowserWallet as qt, Transaction as _r } from "@martifylabs/mesh";
var qe = { exports: {} }, B = {};
...
(function(e) {
  process.env.NODE_ENV === "production" ? e.exports = xr() : e.exports = kr();
})(qe);
function Rr(e) {
  function n(S, y, b, A, i) {
    for (var j = 0, p = 0, U = 0, M = 0, $, l, X = 0, Z = 0, P, J = P = $ = 0, z = 0, re = 0, Ee = 0, oe = 0, je = b.length, xe = je - 1, pe, k = "", q = "", We = "", ke = "", _e; z < je; ) {
      if (l = b.charCodeAt(z), z === xe && p + M + U + j !== 0 && (p !== 0 && (l = p === 47 ? 10 : 47), M = U = j = 0, je++, xe++), p + M + U + j === 0) {
        if (z === xe && (0 < re && (k = k.replace(D, "")), 0 < k.trim().length)) {
          switch (l) {
            case 32:
            case 9:
            case 59:
        ...
        switch (l) {
          case 123:
            for (k = k.trim(), $ = k.charCodeAt(0), P = 1, oe = ++z; z < je; ) {
            ...
            switch (P = b.substring(oe, z), $ === 0 && ($ = (k = k.replace(C, "").trim()).charCodeAt(0)), $) {
              case 64:
                switch (0 < re && (k = k.replace(D, "")), l = k.charCodeAt(1), l) {
                  case 100:
                  case 109:
                  case 115:
                  case 45:
                ...
                if (P = n(y, re, P, l, i + 1), oe = P.length, 0 < se && (re = t(be, k, Ee), _e = f(3, P, re, y, G, ie, oe, l, i, A), k = re.join(""), _e !== void 0 && (oe = (P = _e.trim()).length) === 0 && (l = 0, P = "")), 0 < oe)
                  switch (l) {
                    case 115:
                      k = k.replace(ae, s);
                    case 100:
                    ...
                    case 45:
                      ...
                      break;
                    case 107:
                      k = k.replace(g, "$1 $2"), P = k + "{" + P + "}", P = K === 1 || K === 2 && c("@" + P, 3) ? "@-webkit-" + P + "@" + P : "@" + P;
                      break;
                    default:
                      P = k + P, A === 112 && (P = (q += P, ""));
                  }
                ...
                break;
              default:
                P = n(y, t(y, k, Ee), P, A, i + 1);
            }
            We += P, P = Ee = re = J = $ = 0, k = "", l = b.charCodeAt(++z);
            break;
          case 125:
          case 59:
            if (k = (0 < re ? k.replace(D, "") : k).trim(), 1 < (oe = k.length))
              switch (J === 0 && ($ = k.charCodeAt(0), $ === 45 || 96 < $ && 123 > $) && (oe = (k = k.replace(" ", ":")).length), 0 < se && (_e = f(1, k, y, S, G, ie, q.length, A, i, A)) !== void 0 && (oe = (k = _e.trim()).length) === 0 && (k = "\0\0"), $ = k.charCodeAt(0), l = k.charCodeAt(1), $) {
                case 0:
                  break;
                case 64:
                  if (l === 105 || l === 99) {
                ...
                default:
                  k.charCodeAt(oe - 1) !== 58 && (q += a(k, $, l, k.charCodeAt(2)));
              }
            Ee = re = J = $ = 0, k = "", l = b.charCodeAt(++z);
        }
      }
      switch (l) {
        case 13:
        case 10:
          p === 47 ? p = 0 : 1 + $ === 0 && A !== 107 && 0 < k.length && (re = 1, k += "\0"), 0 < se * ve && f(0, k, y, S, G, ie, q.length, A, i, A), ie = 1, G++;
          break;
        case 59:
        case 125:
          if (p + M + U + j === 0) {
...
function sn(e) {
  var n, t, o, a, c = e === void 0 ? Pe : e, s = c.options, f = s === void 0 ? Pe : s, h = c.plugins, v = h === void 0 ? Qe : h, w = new Rr(f), C = [], D = function(O) {
    function x(I) {
      if (I)
        try {
          O(I + "}");
...
` + j + r;
    ...
    function l(r, u) {
      ...
      try {
        ...
        if (Re && R && typeof Re.stack == "string") {
...
` + W[Q].replace(" at new ", " at ");
      ...
      if (typeof r == "object")
        switch (r.$$typeof) {
          ...
          case C:
            return P(r.type, u, m);
          case D: {
            var R = r, Y = R._payload, H = R._init;
            try {
              return P(H(Y), u, m);
            } catch {
            }
          ...
          if (H(r, L)) {
            ...
            try {
              if (typeof r[L] != "function") {
                var de = Error((R || "React class") + ": " + m + " type `" + L + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof r[L] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
                throw de.name = "Invariant Violation", de;
              }
              W = r[L](u, L, R, m, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
            } catch (Q) {
              W = Q;
            }
            W && !(W instanceof Error) && (Ee(Y), g("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", R || "React class", m, L, typeof W), Ee(null)), W instanceof Error && !(W.message in z) && (z[W.message] = !0, Ee(Y), g("Failed %s type: %s", m, W.message), Ee(null));
          }
      }
    }
    ...
    function cr(r, u) {
      if (typeof r.ref == "string" && ke.current && u && ke.current.stateNode !== u) {
        var m = G(ke.current.type);
        rt[m] || (g('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', G(ke.current.type), r.ref), rt[m] = !0);
      }
    }
    function lr(r, u) {
      {
    ...
    function fr(r, u, m, R, Y) {
      {
        ...
        return dr(r, W, de, Y, R, ke.current, L);
      }
    }
    ...
    function Rt(r, u) {
      {
        ...
        kt[m] = !0;
        var R = "";
        r && r._owner && r._owner !== nt.current && (R = " It was passed a child from " + G(r._owner.type) + "."), $e(r), g('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', m, R), $e(null);
      }
    }
    function At(r, u) {
      {
    ...
    function vr(r) {
      {
        for (var u = Object.keys(r.props), m = 0; m < u.length; m++) {
          var R = u[m];
          if (R !== "children" && R !== "key") {
            $e(r), g("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", R), $e(null);
            break;
          }
        }
...
(function(e) {
  process.env.NODE_ENV === "production" ? e.exports = xn() : e.exports = kn();
})(tt);
const Ne = tt.exports.Fragment, N = tt.exports.jsx, De = tt.exports.jsxs, Xn = ({
  ...
  const o = bt().find((c) => c.name === n), a = Rn();

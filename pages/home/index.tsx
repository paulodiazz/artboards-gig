...
export default function Home() {
  ...
  return (
    <Container>
      <Typography variant="h4" align="center" gutterBottom>Replacing Billboards with Art</Typography>
      ...
      <Typography variant="h4" align="center" gutterBottom>Collector Benefits</Typography>
